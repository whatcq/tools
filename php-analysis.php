...
?><!DOCTYPE html><html lang="zh-cn"><head><meta name="robots" content="noindex, nofollow, noarchive" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title><?php echo $msg;?></title><style>body{padding:0;margin:0;word-wrap:break-word;word-break:break-all;font-family:Courier,Arial,sans-serif;background:#EBF8FF;color:#5E5E5E;}div,h2,p,span{margin:0; padding:0;}ul{margin:0; padding:0; list-style-type:none;font-size:0;line-height:0;}#body{margin:0 auto;}#main{width:95%;margin:13px auto 0 auto;padding:0 0 35px 0;}#contents{margin:13px auto 0 auto;background:#FFF;padding:8px 0 8px 9px;}#contents h2{display:block;background:#CFF0F3;font:bold 20px Arial;padding:12px 0 12px 30px;margin:0 10px 22px 1px;}#contents ol{padding:0 0 0 18px;font-size:0;line-height:0;}#contents ol li{padding:0;color:#8F8F8F;background-color:inherit;font:normal 14px Arial, Helvetica, sans-serif;margin:0;}#contents ol li span{display:block;color:#408BAA;background-color:inherit;font:bold 14px Arial, Helvetica, sans-serif;padding:0 0 10px 0;margin:0;}.code-block{width:auto;font:normal 14px Arial, Helvetica, sans-serif;border:#EBF3F5 solid 4px;margin:0 30px 20px 0;padding:10px 20px;line-height:110%;}.code-block span{padding:0;margin:0;}.code-block .current{background:#CFF0F3;}code{font-family:Courier,Arial,sans-serif;}.code-block i{color:#bebebe;margin-right: 10px;}</style></head><body><div id="main"><div id="contents"><h2><?php echo $msg?></h2><ol><?php foreach($traces as $trace){if(is_array($trace)&&!empty($trace["file"])){$sourceLine = _err_getsource($trace["file"], $trace["line"]);if($sourceLine){?><li><span><?php echo $trace["file"];?> on line <?php echo $trace["line"];?> </span></li><div class="code-block"><?php foreach($sourceLine as $singleLine)echo $singleLine;?></div><?php }}}?></ol></div></div><div style="clear:both;padding-bottom:50px;" /></body></html><?php
    exit;
}
